...
export class GTC__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class GTC extends ethereum.SmartContract {
  static bind(address: Address): GTC {
    return new GTC("GTC", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): GTC__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new GTC__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<GTC__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new GTC__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
